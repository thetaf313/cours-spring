...
@RestController
@RequestMapping("/newclasse")
public class NewClasseController {
    private final IClasseService classeService;
    private final ClasseMapper classeMapper;
    private final ClasseHelper classeHelper;

    public NewClasseController(IClasseService classeService, ClasseMapper classeMapper, ClasseHelper classeHelper) {
